...
- Квадрат різниці двох векторів: $d^2(a,b) = ||a - b||^2 = (a - b) * (b - a)$
- Перемножуємо кожен член і отримуємо: $d^2(a,b) = ||a||^2 - 2 * (a * b) + ||b||^2$
- Нормалізуємо: $d^2(a,b) =1 - 2 * (a * b) + 1 = 2 - 2 * (a * b)$
- Формула косинусної подібності: $Cosine(a,b) = \frac{a*b} {||a||*||b||}$
- Нормалізація приводить вектори до одиниці, відповідно: $Cosine(a,b) = \frac{a*b} {1*1} = a * b$
- Зводимо: $d^2(a,b) = 2 - 2 * Cosine(a,b)$
